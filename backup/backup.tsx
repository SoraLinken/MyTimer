      ...
      <View style={styles.rootContainer}>
          <View style={styles.maincontainer}>
                ...
                <View style={styles.IconWithInput}>
                    ...
                    />
                    <Image source={require('./assets/callSquare.png')} style={styles.call}/>
                </View>
                <View style={styles.IconWithInput}>
                  <TextInput
                    style={styles.input}
                  ...
                  />
                  <Image source={require('./assets/messageSquare.png')} style={styles.call}/>
                </View>
                <View style={[styles.footerContainer]}>
                  <Pressable style={styles.button}> 
                    <LinearGradient  colors={['#dd4f36', '#c13a23', '#c42248', '#81132d']}
                      ...
                      <Image style={styles.arrow} source={require('./assets/login-button-arrow.png')}></Image>
                    </LinearGradient> 
                  </Pressable>
